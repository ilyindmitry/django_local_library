...
class AuthorTestData(TestCase):
    ...
    def test_view_url_accessiable_by_name(self):
...
class RenewBookInstanceViewTest(TestCase):
    ...
    def test_HTTP404_for_invaid_book_if_logged_in(self):
        import uuid
        test_uid = uuid.uuid4()
        login = self.client.login(username='testuser2', password='12345')
    ...
    def test_form_invalid_renewal_date_fututre(self):
        login = self.client.login(username='testuser2', password='12345')
